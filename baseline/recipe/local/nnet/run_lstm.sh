...
mer=$1
dev=data-fbank/test_mer$mer
train=data-fbank/train_mer$mer

dev_original=data/test_mer$mer
train_original=data/train_mer$mer

gmm=exp/mer$mer/tri4
