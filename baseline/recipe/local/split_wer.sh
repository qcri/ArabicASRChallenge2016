...
min_lmwt=9
max_lmwt=20
for dir in exp/*/*decode* exp/nnet2_online*/nnet_a_gpu*/decode* exp/seqDNN_lstm_combine; do
...
for x in exp/*/*decode* exp/nnet2_online*/nnet_a_gpu*/decode* exp/seqDNN_lstm_combine; do [ -d $x ] && grep WER $x/wer_report_* | utils/best_wer.sh; done | sort -n -k2 

echo "Conversational Results WER:"
for x in exp/*/*decode* exp/nnet2_online*/nnet_a_gpu*/decode* exp/seqDNN_lstm_combine; do [ -d $x ] && grep WER $x/wer_conversational_* | utils/best_wer.sh; done | sort -n -k2

echo "Combined Results for Reports and Conversational WER:"
for x in exp/*/*decode* exp/nnet2_online*/nnet_a_gpu*/decode* exp/seqDNN_lstm_combine; do [ -d $x ] && grep WER $x/wer_?? $x/wer_?| utils/best_wer.sh; done | sort -n -k2
